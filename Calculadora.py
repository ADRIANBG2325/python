...
button_suma = Tk.Button(text="+", command=suma, width=10, height=1)
button_resta = Tk.Button(text="-", command=resta, width=10, height=1)
button_multi = Tk.Button(text="*", command=multi, width=10, height=1)
button_div = Tk.Button(text="/", command=div, width=10, height=1)
button_potencia = Tk.Button(text="^", command=potencia, width=10, height=1)
...
label_num1.place(x=50, y=30)
entry_num1.place(x=50, y=10)
label_num2.place(x=200, y=30)
entry_num2.place(x=200, y=10)
button_suma.place(x=350, y=30)
button_resta.place(x=350, y=70)
button_multi.place(x=350, y=110)
button_div.place(x=350, y=150)
button_potencia.place(x=350, y=190)
button_ac.place(x=350, y=230)
label_resultado.place(x=50, y=60)

# Botones de los números
button_n0.place(x=50, y=140)
button_n1.place(x=90, y=140)
button_n2.place(x=130, y=140)
button_n3.place(x=170, y=140)
button_n4.place(x=210, y=140)
button_n5.place(x=50, y=190)
button_n6.place(x=90, y=190)
